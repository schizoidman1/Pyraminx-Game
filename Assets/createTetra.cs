...
public class createTetra : MonoBehaviour {
    ...
    // Método para ajustar os vértices para que o pivô fique no centro
    void CenterPivot()
    {
        // Calcula o centro geométrico do tetraedro
        Vector3 center = (p0 + p1 + p2 + p3) / 4;

        // Subtrai o centro geométrico de cada vértice para reposicionar o pivô
        p0 -= center;
        p1 -= center;
        p2 -= center;
        p3 -= center;
    ...
    public void Rebuild()
    {
        // Chama o método para centralizar o pivô
        CenterPivot();
